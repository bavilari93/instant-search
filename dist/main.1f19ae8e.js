    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('https://restcountries.eu/rest/v2/all?fields=name;population;flag').then(function (res) {
              return res.json();
            });
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            // clearHTML
            results.innerHTML = ''; // getting the data
          ...
          case 3:
            ...
            countries.filter(function (country) {
              ...
              var country_population = document.createElement('h2');
              var country_popupation_text = document.createElement('h5');
...
search_input.addEventListener('input', function (e) {
  search_term = e.target.value; // re-display countries again based on the new search_term
